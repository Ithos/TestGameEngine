...
#ifndef GEOMETRYPOSTPROCESSTEST_H
#define GEOMETRYPOSTPROCESSTEST_H
...
namespace UnitTest
{
	/// Test for a scene with dynamic shadows using translucent effect shaders and post processes applied to specific graphic items
	class CGeometryPostProcessTest : public CBaseGeometryTest
	{
	public:
		/// Constructor
		CGeometryPostProcessTest() : mpSphere(nullptr), mpCube(nullptr), mpQuad(nullptr), mpSkyboxCube(nullptr), mpFloorCube(nullptr), mpMainLight(nullptr), mpSecondLight(nullptr), mpCam(nullptr),
			CBaseGeometryTest() {};
		/// Copy constructor
		/// \param ref Object to be copied
		CGeometryPostProcessTest(const CGeometryPostProcessTest& ref) : mpSphere(nullptr), mpCube(nullptr), mpQuad(nullptr), mpSkyboxCube(nullptr), mpFloorCube(nullptr),
		...
		/// Destructor
		virtual ~CGeometryPostProcessTest();
		...
		virtual CBaseGeometryTest* Clone() const override { return new CGeometryPostProcessTest(*this); };
	...
	protected:
		...
		static const std::string GEOM_POST_PROCESS_TEST_IMAGE;
		...
		virtual void copy(const CGeometryPostProcessTest& ref);
