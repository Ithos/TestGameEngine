...
const std::string UnitTest::CShadowSceneTest::SHADOW_SCENE_TEST_IMAGE = "SHADOW_SCENE_TEST_IMAGE";
const std::string UnitTest::CShadowSceneTest::DEFAULT_LOG_IMAGE_NAME = "ShadowSceneTest";
