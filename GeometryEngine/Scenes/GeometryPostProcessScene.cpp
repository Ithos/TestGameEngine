...
#include "../Render Utils/RenderSteps/GeometryPostProcessPass.h"
...
#include "GeometryPostProcessScene.h"

GeometryEngine::GeometryScene::GeometryPostProcessScene::GeometryPostProcessScene(SceneManager * manager, GLdouble fovy, GLdouble zNear, GLdouble zFar, QVector4D clearColor) :
	GeometryScene(manager, fovy, zNear, zFar, clearColor)
{
	...
	mRenderSteps.push_back(new GeometryEngine::GeometryRenderStep::GeometryPostProcessPass());
