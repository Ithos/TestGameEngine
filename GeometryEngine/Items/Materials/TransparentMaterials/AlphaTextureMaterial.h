...
namespace GeometryEngine
{
	namespace GeometryMaterial
	{
		...
		public:
			...
			AlphaTextureMaterial(const CustomShading::MultiShadingInterface* const multiShadingInterface, const std::string & texDir, float thresholdValue = 0.0f, float globalAlphaValue = 1.0f, float shininess = 10.0f, bool translucent = false);
			/// Copy constructor
