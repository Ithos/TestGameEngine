...
namespace GeometryEngine
{
	namespace GeometryMaterial
	{
		...
		public:
			...
			AlphaMultiTextureMaterial(const std::string & ambientTexDir, const std::string & diffuseTexDir, const std::string & specularTexDir, const std::string & emissiveTexDir, 
				float thresholdValue = 0.0f, float globalAlphaValue = 1.0f, float shininess = 10.0f);
			/// Copy constructor
