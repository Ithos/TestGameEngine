...
namespace GeometryEngine
{
	namespace GeometryMaterial
	{
		...
		public:
			...
			AlphaMultiTextureMaterial(const CustomShading::CustomShadingInterface* const customShading, const std::string & ambientTexDir, const std::string & diffuseTexDir, 
